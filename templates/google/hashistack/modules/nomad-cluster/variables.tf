...
variable "cluster_tag_name" {
  ...
  default = "nomad-cluster-test-tag"
}
...
variable "startup_script" {
  ...
  default = "../run-nomad/run-nomad"
}

variable "subnetwork_link" {
  description = "Subnetwork link where you want to provision your cluster instance"
}
