...
resource "google_storage_bucket" "vault_storage_backend_le" {
...
resource "google_storage_bucket_acl" "vault_storage_backend_le" {
  bucket = "${google_storage_bucket.vault_storage_backend_le.name}"
