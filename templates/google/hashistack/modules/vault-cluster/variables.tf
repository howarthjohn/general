...
variable "source_image" {
  description = "The source image used to create the boot disk for a Vault node. Only images based on Ubuntu 16.04 LTS are supported at this time."
    default = "nomad-vault-consul-2018-01-09-022432"
}
...
variable "subnetwork_link" {
  description = "Subnetwork link where you want to provision your vault cluster instance"
}
