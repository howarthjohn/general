...
variable "ca_public_key_file_path" {
  description = "Write the PEM-encoded CA certificate public key to this path (e.g. /../../examples/nomad-consul-image/etc/tls/ca.crt.pem)."
  default = "../../examples/nomad-consul-image/etc/tls/ca.crt.pem"
}

variable "public_key_file_path" {
  description = "Write the PEM-encoded certificate public key to this path (e.g. /../../examples/nomad-consul-image/etc/tls/vault.crt.pem)."
  default = "../../examples/nomad-consul-image/etc/tls/vault.crt.pem"
}

variable "private_key_file_path" {
  description = "Write the PEM-encoded certificate private key to this path (e.g. /../../examples/nomad-consul-image/etc/tls/vault.key.pem)."
  default = "../../examples/nomad-consul-image/etc/tls/vault.key.pem"
}
